    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schema_name', models.SlugField(blank=True, editable=False, help_text='Tenant schema name (auto-filled from company)', max_length=63, null=True)),
                ('company', models.ForeignKey(blank=True, help_text='Company this router belongs to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='routers', to='core.company')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_%(class)s', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_%(class)s', to=settings.AUTH_USER_MODEL)),
            ],
            options={
