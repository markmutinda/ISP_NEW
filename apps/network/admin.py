...
from .models import (
    Router, RouterEvent, MikrotikInterface, HotspotUser, PPPoEUser, MikrotikQueue,
...
class RouterAdmin(admin.ModelAdmin):
    list_display = ('name', 'ip_address', 'router_type', 'status', 'last_seen', 'active_users', 'is_authenticated')
    list_filter = ('router_type', 'status', 'is_active', 'is_authenticated')
    ...
    fieldsets = (
        (None, {
            'fields': ('name', 'router_type', 'model', 'firmware_version', 'location', ('latitude', 'longitude'))
        }),
        ('Connection & Auth', {
...
class OLTDeviceAdmin(admin.ModelAdmin):
    list_display = ('name', 'vendor', 'ip_address', 'status', 'last_sync')
...
class ACSConfigurationAdmin(admin.ModelAdmin):
    list_display = ('name', 'acs_url', 'periodic_interval', 'is_active')
...
class CPEDeviceAdmin(admin.ModelAdmin):
    ...
    list_filter = ('manufacturer', 'connection_status', 'provisioned')
...
class SubnetAdmin(admin.ModelAdmin):
    list_display = ('name', 'network_cidr', 'version', 'total_ips', 'used_ips', 'utilization')
    list_filter = ('version', 'is_public')
...
class VLANAdmin(admin.ModelAdmin):
    list_display = ('vlan_id', 'name', 'subnet')
    list_filter = ()
