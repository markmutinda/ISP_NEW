...
"""
    ...
    def generate_config_script(self, version: str = "7") -> str:
        ...
        sections = [
            ...
            self._section_radius(r),  # Uses hardcoded 1812/1813 (NO interim-update here!)
            self._section_hotspot(r, gateway_ip),  # Uses radius-interim-update=00:03:00
            self._section_walled_garden(r, portal_domain),
            self._section_ssl_certs(r),
            self._section_hotspot_html(r),
            self._section_pppoe(r, pppoe_local) if r.enable_pppoe else "",  # Uses interim-update=00:03:00
...
"""
    ...
    def _section_radius(self, r: Router) -> str:
        ...
        IMPORTANT: interim-update is NOT a valid parameter in /radius menu!
        It is only configured in /ppp aaa and /ip hotspot profile.
        """
...
"""
    ...
    def _section_hotspot(self, r: Router, gateway_ip: str) -> str:
        """
        Hotspot configuration with 3-minute heartbeat.
        
        VALID: radius-interim-update=00:03:00 is a valid parameter in hotspot profile.
        """
        profile_cmd = (
            ...
            f'radius-accounting=yes radius-interim-update=00:03:00 '  # VALID PARAMETER
...
"""
    ...
    def _section_pppoe(self, r: Router, pppoe_local: str) -> str:
        """
        PPPoE configuration with 3-minute heartbeat.
        
        VALID: interim-update=00:03:00 is a valid parameter in /ppp aaa menu.
        """
...
/ppp aaa set use-radius=yes accounting=yes interim-update=00:03:00  # VALID PARAMETER
"""
