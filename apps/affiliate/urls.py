...
urlpatterns = [
    ...
    path("password-reset/otp/request/", views.AffiliatePasswordResetOTPRequestView.as_view(), name="password-reset-otp-request"),
    path("password-reset/otp/confirm/", views.AffiliatePasswordResetOTPConfirmView.as_view(), name="password-reset-otp-confirm"),
    path("password-reset/temp/confirm/", views.AffiliateTemporaryPasswordConfirmView.as_view(), name="password-reset-temp-confirm"),
    ...
    path("admin/affiliates/<int:pk>/password/", views.AdminAffiliatePasswordView.as_view(), name="admin-password"),
