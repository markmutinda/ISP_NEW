...
'''
    ...
    def remove_tenant_radius(self, schema_name: str) -> bool:
        ...
        try:
            ...
            # We pass a flag to generate_docker_compose_override or just let it 
            # read the updated DB (assuming the tenant was already marked inactive/deleted)
            self.generate_docker_compose_override()
    ...
    def generate_port_mapping_file(self):
        ...
        # 2. Generate the Live Sync Script
        sync_script = ports_dir / 'sync_routes.sh'
...
"""
        ...
        print(f"🗺️ [VPN ROUTING] Generated dynamic port map and sync script.")
