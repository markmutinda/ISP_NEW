...
# ============================================================
# DISABLED: This task duplicates apps.radius.tasks.process_expired_subscriptions
# and calls SMSNotifier.pppoe_suspended (which no longer exists).
# Expiry handling is now done in apps.radius.tasks.process_expired_subscriptions
# which includes proper deduplication and pppoe_expired_notice.
# ============================================================
...
# 
#                         # SMS notification is now handled by apps.radius.tasks.process_expired_subscriptions
#                         # which uses pppoe_expired_notice with proper deduplication.
#                         
#                         stats['expired'] += 1
