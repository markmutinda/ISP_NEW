...
class SubscriptionUsageSerializer(serializers.Serializer):
    ...
    billable_pppoe = serializers.IntegerField(required=False)
    pppoe_unit_price = serializers.DecimalField(max_digits=10, decimal_places=2, required=False)
    pppoe_charge = serializers.DecimalField(max_digits=12, decimal_places=2, required=False)
