    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method_type', models.CharField(choices=[('MPESA', 'M-Pesa'), ('CASH', 'Cash'), ('BANK_TRANSFER', 'Bank Transfer'), ('CHEQUE', 'Cheque'), ('CREDIT_CARD', 'Credit Card'), ('DEBIT_CARD', 'Debit Card'), ('MOBILE_MONEY', 'Mobile Money'), ('VOUCHER', 'Voucher'), ('OTHER', 'Other')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('code', models.CharField(max_length=20, unique=True)),
                ('plan_type', models.CharField(choices=[('INTERNET', 'Internet'), ('VOIP', 'VoIP'), ('IPTV', 'IPTV'), ('DEDICATED', 'Dedicated Line'), ('BUSINESS', 'Business'), ('RESIDENTIAL', 'Residential')], default='INTERNET', max_length=20)),
                ('description', models.TextField(blank=True)),
                ...
                ('tax_rate', models.DecimalField(decimal_places=2, default=16.0, max_digits=5, validators=[django.core.validators.MinValueValidator(0)])),
                ...
                ('data_limit', models.PositiveBigIntegerField(default=0, help_text='Data limit in GB (0 for unlimited)')),
                ('burst_limit', models.PositiveIntegerField(blank=True, help_text='Burst speed in Mbps', null=True)),
                ('billing_cycle', models.CharField(choices=[('DAILY', 'Daily'), ('WEEKLY', 'Weekly'), ('MONTHLY', 'Monthly'), ('QUARTERLY', 'Quarterly'), ('ANNUALLY', 'Annually')], default='MONTHLY', max_length=20)),
                ('prorated_billing', models.BooleanField(default=True)),
                ('auto_renew', models.BooleanField(default=True)),
                ('contract_period', models.PositiveIntegerField(default=0, help_text='Contract period in months (0 for no contract)')),
