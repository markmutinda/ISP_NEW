    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['trigger_event'], name='notificatio_trigger_bf38a2_idx'), models.Index(fields=['notification_type'], name='notificatio_notific_d9e94e_idx'), models.Index(fields=['is_active'], name='notificatio_is_acti_b2a982_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            model_name='notification',
            index=models.Index(fields=['recipient_email', 'status'], name='notificatio_recipie_47102c_idx'),
        ),
        migrations.AddIndex(
            model_name='alertrule',
            index=models.Index(fields=['is_active', 'alert_type'], name='notificatio_is_acti_849c63_idx'),
        ),
    ]
